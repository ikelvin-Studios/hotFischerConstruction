                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>Committed
                                ...
                                and Results</h1>
                            <p>Since our beginning, we have built our business on honesty and integrity. Our open and honest communication has allowed us to build great relationships with our clients, partners and subcontractors and deliver quality results in our work.  </p>
                            <a href="services.php" class="btn_1">What We Do </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_part_text">
                        <h2>Engineering Your
                            Dreams With Us</h2>
                        <p>We have built our reputation as a construction services firm that puts people first. By harnessing the power of relationships between our company, our partners and our clients, we transform landscapes, communities and minds. We’re also comfortable with good coffee and conversation.</p>
                        <ul>
                            <li>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_service">
                            <span class="flaticon-ui"></span>
                            <h4>Construction</h4>
                            <p>We build Houses, factories, roads, dams and interchanges</p>
                            <a href="services.php" class="btn_3">read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_service">
                                <span class="flaticon-ui"></span>
                            <h4>Mining And Oil Refinery</h4>
                            <p>We into mining of gold and building oil refinery facilities.</p>
                            <a href="services.php" class="btn_3">read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_service single_service_2">
                            ...
                            <p>We supply and distribute machinery for construction, mining, drilling and refinery as well as trains and its components.</p>
                            <a href="services.php" class="btn_3">read more</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="about_part_text">
                        <h2>We Are Experienced
                                in Construction</h2>
                        <p>Our organization's ability to learn from expierence, and translate that learning into action rapidly, is the ultimate competitive advantage .</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single_member_counter">
                        ...
                        <h4> <span>+ Satisfied</span> Clients</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single_member_counter">
                        ...
                        <h4> <span>+ Construction</span> Projects</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_counter_icon">
                    ...
                    <div class="single_member_counter">
                        ...
                        <h4> <span>+ Years</span> Experience</h4>
                    </div>
                </div>
            </div>
        </div>
